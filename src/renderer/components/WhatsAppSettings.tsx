...
export function WhatsAppSettings({ onStatusChange }: WhatsAppSettingsProps) {
  ...
  const [testResult, setTestResult] = useState<{ success: boolean; error?: string; phoneNumber?: string } | null>(null);
  ...
  const handleRemoveChannel = async () => {
    ...
    if (!confirm('Are you sure you want to remove the WhatsApp channel? This will log out your WhatsApp session.')) {
      return;
    }
  ...
  const handleLogout = async () => {
    ...
    if (!confirm('Are you sure you want to log out from WhatsApp? You will need to scan the QR code again.')) {
      return;
    }
      ...
      <div className="whatsapp-settings">
        <div className="settings-section">
          ...
          <div className="settings-field">
            ...
            <p className="settings-hint">
              Enable this if you're using your own WhatsApp number (messaging yourself).
              Bot responses will be prefixed to distinguish them from your messages.
            </p>
          </div>
          ...
          <div className="settings-info-box">
            ...
            This way the bot appears as a separate contact instead of messaging yourself.
          </div>
        ...
        <div className="settings-section settings-info">
          ...
          <p className="settings-warning">
            <strong>Note:</strong> WhatsApp Web sessions may be logged out if you use the same account on another WhatsApp Web instance.
          </p>
        </div>
      </div>
    );
      ...
      <div className="whatsapp-settings">
        <div className="settings-section">
          ...
          <div className="qr-code-container">
            {qrLoading && !qrDataUrl ? (
              ...
              <img src={qrDataUrl} alt="WhatsApp QR Code" className="qr-image" style={{ width: 256, height: 256 }} />
            ) : (
              <div className="qr-loading">
        ...
        <div className="settings-section">
          ...
          <div className="settings-field">
            ...
            <p className="settings-hint">
              Enable this if you're using your own WhatsApp number.
              Bot responses will be prefixed to distinguish them from your messages.
            </p>
          </div>
